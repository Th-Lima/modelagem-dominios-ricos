...
public class AssertionConcern
{
    ...
    public static void ValidarSeMenorIgualAMinimo(long valor, long minimo, string mensagem)
    {
        if (valor <= minimo)
            throw new DomainException(mensagem);
    }
    
    public static void ValidarSeMenorIgualAMinimo(double valor, double minimo, string mensagem)
    {
        if (valor <= minimo)
            throw new DomainException(mensagem);
    }
    ...
    public static void ValidarSeMenorIgualAMinimo(int valor, int minimo, string mensagem)
    {
        if (valor <= minimo)
            throw new DomainException(mensagem);
    }
