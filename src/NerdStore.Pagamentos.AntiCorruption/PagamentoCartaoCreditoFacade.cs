...
public class PagamentoCartaoCreditoFacade : IPagamentoCartaoCreditoFacade
{
    ...
    private readonly IPagamentosConfigurationManager _configManager;

    public PagamentoCartaoCreditoFacade(IPayPalGateway payPalGateway, IPagamentosConfigurationManager configManager)
    {
