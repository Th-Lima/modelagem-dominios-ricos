...
public static class MediatorExtension
{
    ...
    public static async Task PublicarEventosAsync(this IMediatorHandler mediator, VendasContext ctx)
    {
        ...
        /// Transformando em uma lista e limpando os eventos das entidades em seguida
